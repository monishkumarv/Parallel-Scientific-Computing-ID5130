#include<stdio.h>
#include<string.h>
#include<mpi.h> 		// new header and contains the function prototypes, macros, variables..
...
int main(int argc, char** argv)
{
  ...
  MPI_Comm_size(MPI_COMM_WORLD, &size);             // tells about the number of processes and stores it in ...&size
  MPI_Comm_rank(MPI_COMM_WORLD, &myid);             // will return the rank or id of the process that called it and stores it in ...&myid
